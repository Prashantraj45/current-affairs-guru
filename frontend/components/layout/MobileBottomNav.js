...
import { BookOpenText, Clock3, House } from 'lucide-react';

const ITEMS = [
  { href: '/', label: 'Daily Brief', Icon: House },
  { href: '/history', label: 'Chronicle', Icon: Clock3 },
  { href: '/intel-canvas', label: 'Signal Deck', Icon: BookOpenText },
];
